...
@Composable
fun NoteItem(
  note: Note, modifier: Modifier = Modifier, cornerRadius: Dp = 10.dp,
  cutCornerSize: Dp = 30.dp, onDeleteItem: () -> Unit,
  ...
  Box(
    ...
    Canvas(modifier = Modifier.matchParentSize()) {
      ...
      clipPath(clipPath) {
        ...
        drawRoundRect(
          color = Color(ColorUtils.blendARGB(note.color, android.graphics.Color.BLACK, 0.2f)),
